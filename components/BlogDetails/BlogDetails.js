                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-standard-image">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi ti-user"></i> By <Link href="/blog-single/The-Golden-Ratio-2D-Sketch">{BlogDetails?.author}</Link> </li>
                                        <li><i className="fi ti-comment-alt"></i> Comments {BlogDetails?.comment}</li>
                                        <li><i className="fi ti-calendar"></i> {BlogDetails?.create_at}</li>
                                    </ul>
                                </div>
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch">Planning</Link></li>
                                        <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch">Architecture</Link></li>
                                        <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch">creative</Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="tag-share-s2 clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch">facebook</Link></li>
                                        <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch">twitter</Link></li>
                                        <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch">linkedin</Link></li>
                                        <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch">pinterest</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link href="/blog-single/The-Golden-Ratio-2D-Sketch" target="_blank"><img src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link href="/blog-single/The-Golden-Ratio-2D-Sketch" className="author-name">Author: Jenny Watson</Link>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                    <div className="socials">
                                        <ul className="social-link">
                                            <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch"><i className="ti-facebook"></i></Link></li>
                                            <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch"><i className="ti-twitter-alt"></i></Link></li>
                                            <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch"><i className="ti-linkedin"></i></Link></li>
                                            <li><Link href="/blog-single/The-Golden-Ratio-2D-Sketch"><i className="ti-instagram"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div className="comment-wrapper">
                                                        ...
                                                        <div className="comment-area">
                                                            ...
                                                            <div className="comments-reply">
                                                                <Link className="comment-reply-link" href="/blog-single/The-Golden-Ratio-2D-Sketch"><span>Reply</span></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
