...
const ServiceSection = () => {
  ...
  return (
    <section className="relative bg-[#1E2E3E] px-6 md:px-12 lg:px-24 py-16 overflow-hidden">
      {/* Background shapes */}
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center">
          <div className="w-full lg:w-[414px] mb-10 lg:mb-0">
            <div className="text-left lg:pr-8">
              ...
              <p className="text-white mb-5">{data.description}</p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-[calc(100%-414px)] lg:ml-[70px] relative">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#1E2E3E] to-transparent z-10 hidden lg:block"></div>
            <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#1E2E3E] to-transparent z-10 hidden lg:block"></div>
              ...
              <div
                ...
                style={{
                  transform: `translateX(-${
                    currentSlide * (isMobile ? window.innerWidth * 0.9 : 384)
                  }px)`,
