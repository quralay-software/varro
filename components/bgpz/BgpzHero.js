            ...
            <div className="absolute md:hidden bottom-4 left-4 right-4 grid grid-cols-3 gap-2 bg-black/20 p-2 rounded-lg">
                <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg">
                    <div className="text-white text-center">
                        <div className="text-xl font-bold mb-1">{data.stats.capacity.value}</div>
                        <div className="text-[10px] font-semibold">{data.stats.capacity.label}</div>
                    </div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg">
                    <div className="text-white text-center">
                        <div className="text-xl font-bold mb-1">{data.stats.equipment.value}</div>
                        <div className="text-[10px] font-semibold">{data.stats.equipment.label}</div>
                    </div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-3 rounded-lg">
                    <div className="text-white text-center">
                        <div className="text-xl font-bold mb-1">{data.stats.construction.value}</div>
                        <div className="text-[10px] font-semibold">{data.stats.construction.label}</div>
                    </div>
                </div>
            </div>
