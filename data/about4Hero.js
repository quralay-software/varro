export const about4HeroData = {
  ru: {
    company: "Varro Operating Group",

    description:
      "Компания «Varro Operating Group» была зарегистрирована 9 марта 2022 года и специализируется на разработке и добыче углеводородов в пределах лицензированных участков недр. 6 октября 2022 года мы подписали контракт № 5113-УВС на добычу углеводородов на месторождении Толкын сроком на 25 лет (до 2047 года), который был заключен по результатам аукциона, проведенного Министерством энергетики Республики Казахстан.",
    description2:
      "Месторождение Толкын расположено в Бейнеуском районе, на границе с Атырауской областью. Ближайшие населенные пункты — железнодорожная станция Опорная (15 км), поселок Сарыкамыс (50 км) и рабочий поселок Тенгиз (70 км). Областные центры — Актау (600 км) и Атырау (320 км). Площадь месторождения составляет 49 км².",
    description3:
      "Мы предоставляем широкий спектр услуг в области добычи и переработки нефти и газа, с акцентом на инновации, устойчивое развитие и минимизацию воздействия на окружающую среду. В рамках нашей деятельности мы занимаемся разработкой месторождения Толкын, управляем Боранкольским газоперерабатывающим заводом (БГПЗ) и осуществляем поставки продукции на внутренний и международный рынки. Наши приоритеты – инновации, эффективность и устойчивое развитие.",
  },
  kk: {
    company: "Varro Operating Group",
    ...
    description3:
      "Біз мұнай мен газды өндіру және қайта өңдеу саласында инновацияларға, тұрақты дамуға және қоршаған ортаға әсерді азайтуға бағытталған кең ауқымды қызметтер ұсынамыз. Біздің қызметіміздің аясында біз Толқын кен орнын игереміз, Боранкөл газ өңдеу зауытын (БГӨЗ) басқарамыз және өнімді ішкі және халықаралық нарықтарға жеткіземіз. Біздің басымдықтарымыз – инновация, тиімділік және тұрақты даму.",
  },
  en: {
    company: "Varro Operating Group",
