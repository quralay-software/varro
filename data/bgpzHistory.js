export const bgpzHistoryData = {
    ru: {
        section_title: 'История развития',
        main_title: 'История БГПЗ',
        description: 'С момента основания БГПЗ постоянно развивается, внедряя новые технологии и повышая эффективность производства.',
        timeline: [
            {
                year: '2007',
        ...
        future_vision: {
            ...
            description: 'К 2030 году БГПЗ планирует стать одним из самых технологически развитых газоперерабатывающих предприятий в регионе, с полной автоматизацией процессов и минимальным воздействием на окружающую среду.',
            goals: [
                'Полная цифровизация производства',
    ...
    kk: {
        section_title: 'Даму тарихы',
        main_title: 'БГӨЗ тарихы',
        description: 'Құрылған сәттен бастап БГӨЗ үздіксіз дамып келеді, жаңа технологияларды енгізіп, өндіріс тиімділігін арттыруда.',
        timeline: [
            {
                year: '2007',
                title: 'I кезең құрылысының аяқталуы',
                description: 'Жылына 3,6 млрд м³ газ жобалық қуатына қол жеткізілді.',
                achievements: [
                    'Негізгі өндірістік қуаттарды іске қосу',
                    'Базалық инфрақұрылымды құру',
                    'Мамандар командасын қалыптастыру'
                ]
            },
            {
                year: '2024',
        ...
        future_vision: {
            ...
            description: '2030 жылға қарай БГӨЗ аймақтағы процестерді толық автоматтандырумен және қоршаған ортаға минималды әсер етумен ең технологиялық дамыған газ өңдеу зауыттарының біріне айналуды жоспарлап отыр.',
            goals: [
                'Өндірісті толық цифрландыру',
    ...
    en: {
        ...
        description: 'Since its foundation, BGPZ has been continuously developing, implementing new technologies and improving production efficiency.',
        timeline: [
            {
                year: '2007',
                title: 'Completion of Phase I Construction',
                description: 'Achieved design capacity of 3.6 billion m³ of gas per year.',
                achievements: [
                    'Launch of main production facilities',
                    'Creation of basic infrastructure',
                    'Formation of specialist team'
                ]
            },
            {
                year: '2024',
        ...
        future_vision: {
            ...
            description: 'By 2030, BGPZ plans to become one of the most technologically advanced gas processing plants in the region, with full process automation and minimal environmental impact.',
            goals: [
