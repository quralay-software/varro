export const bgpzTechnologyData = {
    ru: {
        section_title: 'Технологии',
        main_title: 'Наши технологические процессы',
        description: 'Мы используем передовые технологии для обеспечения эффективной и экологичной переработки газа',
        technologies: [
            {
                icon: 'Filter',
    ...
    kk: {
        section_title: 'Технологиялар',
        main_title: 'Біздің технологиялық процестер',
        description: 'Біз газды тиімді және экологиялық өңдеуді қамтамасыз ету үшін озық технологияларды қолданамыз',
        technologies: [
            {
                icon: 'Filter',
    ...
    en: {
        ...
        main_title: 'Our Technological Processes',
        description: 'We use advanced technologies to ensure efficient and environmentally friendly gas processing',
        technologies: [
            {
                icon: 'Filter',
                ...
                details: [
                    ...
                    'Modern catalysts and adsorbents'
                ],
                stats: {
                    efficiency: {
                        value: '99.9%',
