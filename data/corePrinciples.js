export const corePrinciplesData = {
  ru: {
    sectionTitle: "Наши принципы",
    mainTitle: "Ключевые принципы работы",
    description:
      "Наши принципы определяют все аспекты нашей деятельности и помогают нам достигать высоких результатов, сохраняя баланс между бизнесом, обществом и окружающей средой.",
    principles: [
      {
        id: 2,
        icon: "trending-up",
  ...
  kk: {
    sectionTitle: "Біздің қағидаларымыз",
    mainTitle: "Жұмыстың негізгі қағидалары",
    description:
      "Біздің қағидаларымыз біздің қызметіміздің барлық аспектілерін анықтайды және бизнес, қоғам және қоршаған орта арасындағы тепе-теңдікті сақтай отырып, жоғары нәтижелерге қол жеткізуге көмектеседі.",
    principles: [
      {
        id: 2,
        icon: "trending-up",
  ...
  en: {
    ...
    mainTitle: "Core Working Principles",
    description:
      "Our principles define all aspects of our operations and help us achieve high results while maintaining a balance between business, society, and the environment.",
    principles: [
      {
        id: 2,
        icon: "trending-up",
