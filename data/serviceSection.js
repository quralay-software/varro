export const serviceSectionData = {
    ru: {
        ...
        description: 'Компания Varro Operating Group предоставляет широкий спектр услуг в области добычи и переработки нефти и газа. Мы стремимся к инновациям, устойчивому развитию и минимизации воздействия на окружающую среду.',
        viewAllButton: 'Все услуги....',
        services: [
            {
                id: '1',
    ...
    kk: {
        ...
        description: 'Varro Operating Group компаниясы мұнай және газ өндіру және өңдеу саласында кең ауқымды қызметтер ұсынады. Біз инновацияларға, тұрақты дамуға және қоршаған ортаға әсерді азайтуға ұмтыламыз.',
        viewAllButton: 'Барлық қызметтер....',
        services: [
            {
                id: '1',
